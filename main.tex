...
\shorttitlePL{Wyłącznik awaryjny pojazdu autonomicznego} %% zdalny wyłącznik awaryjny pojazdu autonomicznego
...
\include{rozdzial1_wstep_i_wymagania}
\include{rozdzial2_wykonanie_projektu}
\include{rozdzial3_podsumowanie}
