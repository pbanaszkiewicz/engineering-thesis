...
\toprule
Numer wymagania & Wymagane? & Spełnione? & Jak? & Rozdział \\
\midrule
...
1.5.1 & Tak & Tak & Wejście sterowania przekaźnika jest optoizolowane. & \ref{subsec:odlaczanie_zalaczanie_silnika} \\ \hline  %% aktualizuj bazujac na dokumentacji od ANLY?
...
1.5.3 & Tak & Tak & Przekaźnik dopiero wystawiony na bardzo długie działanie pod wysokim obciążeniem może osiągnąć temperaturę $100\,^{\circ}\mathrm{C}$. & \ref{subsec:chlodzenie_SSR} \\ \hline
...
1.6.7 & Tak & Tak & Spełnione dosłownie. & \ref{subsec:obudowy} \\ \hline
