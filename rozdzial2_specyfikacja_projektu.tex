...
\ref{wym_uzyt3} & Tak & Tak & Przetestowano &  \\ \hline  %% podaj wartosc
\ref{wym_uzyt4} & Tak & Tak & Przetestowano &  \\ \hline  %% podaj wartosc
...
\ref{wym_bezp3} & Tak & Tak & Przekaźnik dopiero wystawiony na bardzo długie działanie pod wysokim obciążeniem może osiągnąć temperaturę $100\,^{\circ}\mathrm{C}$. & \ref{subsec:chlodzenie_SSR} \\ \hline
